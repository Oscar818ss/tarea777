...
function esMayorDeEdad(edad) {
    return edad >= 18;  // Cambiado a >= para incluir a los mayores de 18.
}
...
function saludarPersonalizado(nombre, apellido) {
    return `Hola, ${nombre} ${apellido}`;  // Corregido con comillas invertidas
}
...
const saludar = function (nombre) {
    return `Hola, ${nombre}`;  // Corregido con comillas invertidas
};
...
const saludarFlecha = nombre => `Hola ${nombre}`;  // Corregido con comillas invertidas
